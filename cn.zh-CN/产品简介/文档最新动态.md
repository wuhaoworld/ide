...
|:-|:-|:-|:-|:---|:---|
|2019.08.23|新增插件|新增功能|为您介绍AnalyticDB for MySQL 3.0插件支持的数据类型、字段映射和数据源等参数及配置示例。|所有|[配置AnalyticDB for MySQL 3.0 Reader](../../../../cn.zh-CN/使用指南/数据集成/作业配置/配置Reader插件/配置AnalyticDB for MySQL 3.0 Reader.md#)和[配置AnalyticDB for MySQL 3.0 Writer](../../../../cn.zh-CN/使用指南/数据集成/作业配置/配置Writer插件/配置AnalyticDB for MySQL 3.0 Writer.md#)|
|2019.8.22|新增SLA|新增|为您介绍DataWorks服务等级协议（SLA）。|所有|[DataWorks服务等级协议（SLA）](../../../../cn.zh-CN/相关协议/DataWorks服务等级协议（SLA）.md#)|
|2019.08.21|新增查看账单详情|体验优化|为您介绍如何查看DataWorks按量计费商品中，各计费项的计费明细账单。|所有|[查看账单详情](../../../../cn.zh-CN/产品定价/查看账单详情.md#)|
|2019.08.14|新增使用教程|体验优化|窃电用户自动识别将为您介绍如何通过DataWorks配合机器学习的方式，实现窃电用户的自动识别，保障用户的安全用电。|所有|[窃电用户自动识别教程](../../../../cn.zh-CN/使用教程/实现窃电用户自动识别教程/窃电用户自动识别概述.md#)|
