...
-   问题现象
    ...
    5.  确认访问地址`host:port`、数据库名和用户名是否填写正确。
...
-   问题现象
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/24365/156774774414226_zh-CN.png)
...
-   问题现象
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/24365/156774774414249_zh-CN.png)
...
-   问题现象
    ...
    没有外网地址的DRDS实例，配置数据源时，是否支持将实例的内网地址映射为自定义的域名？
...
-   问题现象
    ...
    添加RDS数据源时，为什么白名单已添加，依然报错提示`user not exist ip white list reference`。
