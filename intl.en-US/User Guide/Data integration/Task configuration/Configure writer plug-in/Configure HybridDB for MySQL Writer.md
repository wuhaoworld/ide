...
**Note:** You must configure a data source before configuring HybridDB for MySQL Writer. For more information, see [Configure a HybridDB for MySQL data source](reseller.en-US/User Guide/Data integration/Data source configuration/Configure HybridDB for MySQL data source.md#).
...
1.  **Specify data sources** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/62205/155859634639919_en-US.png)
...
2.  Configure mappings of fields \(the column parameter in the preceding parameter description\).
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/62195/155859634632070_en-US.png)
...
3.  **Configure channel control**
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/62209/155859634632018_en-US.png)
    ...
    |**Task Resource Group**|The machines on which tasks are run. If a large number of tasks run on the default resource group, some tasks may be delayed due to insufficient resources. In this case, we recommend that you add a custom resource group. Currently, a custom resource group can be added only in China \(Hangzhou\) and China \(Shanghai\). For more information, see[Add task resources](reseller.en-US/User Guide/Data integration/Common configuration/Add task resources.md#).|
