...
![依赖关系](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433013932_zh-CN.png)

DataWorks V2.0提供[自动推荐](#)、[自动解析](#)和[自定义配置](#)三种依赖配置模式。依赖关系实际操作示例请参考[设置调度依赖最佳实践](../../../../intl.zh-CN/最佳实践/数据开发/设置调度依赖最佳实践.md#)。

![调度依赖](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/15669943317925_zh-CN.png)
...
-   在进行调度依赖关系配置前，您需要了解以下基本概念：
    ...
    每个形成上下游关系的任务均通过输出名进行关联，其中创建的最上游节点可以配置为本项目的根节点（节点名projectname\_root）。
...
-   规范化数据开发流程示例
    ...
    ![开发示例](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433113593_zh-CN.jpg)
...
![依赖的上游节点](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/15669943317926_zh-CN.png)
...
-   通过输入父节点输出名的表名称进行搜索
    ...
    ![搜索](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433113933_zh-CN.png)

    执行**提交**后，该输出名即可通过搜索表名的方式被其他节点搜索到。

    ![提交](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433113934_zh-CN.png)
...
![原理图](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433145513_zh-CN.png)
...
![解析多个输出](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433113595_zh-CN.jpg)

如果您构建了存在依赖关系的多个任务且满足条件：下游任务的输入表均来自上游任务的输出表，则通过自动解析功能即可实现全工作流依赖关系的快速配置。

![输出表](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213935_zh-CN.png)
...
![自动解析](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213937_zh-CN.png)
...
![依赖关系](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433221179_zh-CN.png)

当自动解析选择为**否**时，您可以单击**自动推荐**，启用自动推荐上游依赖功能。系统将会基于本项目SQL血缘关系为您推荐产出当前节点输入表的其他所有SQL节点任务，您可以根据自身需求，单选或多选推荐列表中的任务，配置为当前节点的上游依赖任务。
...
-   手动添加依赖的上游节点示例
    1.  新建三个节点，系统会默认为它们分别配置一个输出名称。
        ...
        ![输出名称](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213938_zh-CN.png)

        ![task_1](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213939_zh-CN.png)

        ![task_2](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213940_zh-CN.png)

        ![task_3](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213941_zh-CN.png)

    2.  将最上游节点task\_1配置依赖本项目root根节点，单击**保存**。

        ![保存](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213942_zh-CN.png)

    3.  配置task\_2依赖task\_1的输出名称，单击**保存**。

        ![保存](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433213943_zh-CN.png)

    4.  配置task\_3依赖task\_2的输出名称，单击**保存**。

        ![保存](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433313944_zh-CN.png)

    5.  配置完成后，单击**提交**，判断依赖关系是否正确。如果提交成功则说明依赖配置无误。

        ![提交](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433313945_zh-CN.png)
...
-   通过拖拽形成依赖关系示例
    ...
    2.  通过拖拽方式将三个task连接起来。
        ...
        ![连接task](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433313947_zh-CN.png)

    3.  查看task\_2、task\_3的依赖配置，可以看到已自动生成依赖的父节点输出名。

        ![输出名](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433313948_zh-CN.png)

        ![输出名](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433313949_zh-CN.png)

    4.  配置完成后，单击**提交**，判断依赖关系是否正确。如果提交成功则说明依赖配置无误。

        ![依赖配置](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433313945_zh-CN.png)
...
-   Q：自动解析后提交失败，报错**依赖的父节点输出projectname.table不存在，不能提交本节点，请先提交父节点。**
    ...
    ![提交失败](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433313952_zh-CN.png)
...
-   Q：依赖的上游没有解析到父节点ID，提交报错。
    ...
    ![本节点输出](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433345514_zh-CN.png)
    ...
    1.  找到产出该表的节点任务，查看该节点任务的本节点输出。
        ...
        ![模糊查找](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433445515_zh-CN.png)

    2.  如果是本地上传的表数据，或者不需要依赖该节点，您可以选择在代码区右键，选择**删除输入**。

        ![删除输入](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16303/156699433445516_zh-CN.png)
